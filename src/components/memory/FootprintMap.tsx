...
export default function FootprintMap({ count }: FootprintMapProps) {
  return (
    <section className="rounded-[20px] bg-white border border-[#ded2bf] overflow-hidden shadow-sm">
      <div className="px-4 py-3 flex justify-between items-center border-b border-[#dfd6c5]">
      ...
      <div className="h-28 relative overflow-hidden bg-[#f5efe4]">
